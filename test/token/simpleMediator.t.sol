...
import {LocalTestSetup, GlacisAxelarAdapter, GlacisRouter, AxelarGatewayMock, AxelarGasServiceMock, LayerZeroGMPMock, SimpleTokenMediator, XERC20Sample, GlacisCommons} from "../LocalTestSetup.sol";
...
contract TokenMediatorTests is LocalTestSetup {
    ...
    function test__SimpleTokenMediator_AddsRemoteAddress(
        ...
        assertEq(simpleTokenMediator.remoteCounterpart(chainId), addr);
    }
    ...
    function test__SimpleTokenMediator_RemovesRemoteAddress(
        ...
        assertEq(simpleTokenMediator.remoteCounterpart(chainId), bytes32(0));
    }
